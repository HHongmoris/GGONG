...
import com.a304.ggong.dto.response.AreaAnswerResponse;
...
public interface VoteRepository extends JpaRepository<Vote, Long> {
	...
	@Query("SELECT new com.a304.ggong.dto.response.AllAnswerResponse(q) FROM Question q WHERE q.type = '공통'")
	List<AllAnswerResponse> findByQuestionGroup(int questionGroup);
