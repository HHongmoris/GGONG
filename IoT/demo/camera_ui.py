...
class Ui_CameraWidget(object):
    def setupUi(self, CameraWidget):
        ...
        CameraWidget.setMinimumSize(QSize(800, 480))
        CameraWidget.setMaximumSize(QSize(800, 480))
        ...
        self.video_display.setGeometry(QRect(70, 110, 640, 360))
...
"border-radius : 10px;")
        ...
        self.label.setGeometry(QRect(70, 10, 641, 91))
        font = QFont()
...
"border-radius : 10px;")
        ...
        self.camera_btn.setGeometry(QRect(720, 400, 71, 71))
        font1 = QFont()
